...
if (!$_POST)  {
	...
	if (mysqli_num_rows($get_list_res) < 1) {
		...
		<section>
		<p><button type=\"submit\" id=\"login_button\">Delete Record</button></p></br>
		</form></section></br>";
	}
	//free result
	...
	$display_block = "<div class='card text-center'><h1 class='card-header'>Record(s) Deleted</h1><br/>
	<p>Would you like to <a href=\"".$_SERVER['PHP_SELF']."\">delete another</a>?...Return to the <a href='HomeLibraryMenu.html'>main menu</a>?</p>";
}
?>
<!DOCTYPE html>
<html>
