...
if (($_POST['username']=="") || ($_POST['password']=="")) {
    header("Location: LibraryUser.html");
    exit;
}
$display_block="";
//connect to server and select database
$mysqli = mysqli_connect("localhost",  "lisabalbach_kujawsc", "CIT19020002",  "lisabalbach_Kujawski") or die(mysql_error());
...
if (mysqli_num_rows($result) == 1) {
	header("Location:HomeLibraryMenu.html");
	exit;
} else {
    ...
    $display_block .= "<p style='text-align:center;font-size:2em;'><a href='LibraryUser.html'> Return to login</a></p>";
}
